...
<form action="{buildURL()}" method="post" name="shippingratesform">
          ...
          <table cellpadding="0" cellspacing="3" width="100%">
            <tbody FOREACH="method.markups,mid,markup">
              <tr>
                ...
                <td>{t(#Weight range#)} ({getWeightSymbol()}):</td>
...
<form name="addshippingrate" action="{buildURL()}" method="post" IF="getShippingMethods()">
    ...
    <tr>
      ...
      <td>
        <select name="new[zone_id]">
          <option FOREACH="getShippingZones(),zn" value="{zn.getZoneId()}" selected="{isSelected(zn,#zone_id#,zone_id)}">{zn.getZoneName()}</option>
        </select>
      </td>
      <td colspan="4">&nbsp;</td>
    </tr>
