...
{**
 * Layout template (https://litmus.com/conference/pm-workshop)
 *
...
<head>
  ...
  <title>{getNotificationSubject()}</title>
  <style type="text/css">
    /* RESET STYLES */
    p{ margin:1em 0;}
              ...
              <table align="center" border="0" cellpadding="0" cellspacing="0" width="100%" class="emailContainer">
                <tr>
                  <td align="left" valign="top">
                    ...
                    <h1 class="greeting"><widget template="common/greeting.tpl" /></h1>
                ...
                <tr>
                  <td align="center" valign="top">
                    ...
                    <table border="0" cellpadding="0" cellspacing="0" width="100%">
                      <tr>
                        <td align="left" valign="top" class="footerContent">

                          <widget template="common/signature.tpl" />
