...
class ExpressCheckout extends \XLite\Module\CDev\Paypal\View\Button\AExpressCheckout
{
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += array(
            self::PARAM_PRODUCT_ID => new \XLite\Model\WidgetParam\Int('Product id'),
        );
    }
    ...
    {
        return 'modules/CDev/Paypal/button/product_list/default/express_checkout.tpl';
    }
    ...
    protected function getTemplate()
    {
        return $this->isInContextAvailable()
            ? 'modules/CDev/Paypal/button/product_list/in_context/express_checkout.tpl'
            : 'modules/CDev/Paypal/button/product_list/default/express_checkout.tpl';
    }
