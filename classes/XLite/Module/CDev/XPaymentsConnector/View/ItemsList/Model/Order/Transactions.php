...
class Transactions extends \XLite\View\ItemsList\Model\Table
{
    ...
    protected function defineColumns()
    {
        return array(
            'card' => array(
                static::COLUMN_TEMPLATE => 'modules/CDev/XPaymentsConnector/order/transactions/card.tpl',
                static::COLUMN_NO_WRAP  => true,
                static::COLUMN_ORDERBY  => 200,
                static::COLUMN_MAIN     => true,
            ),
            'links' => array(
                static::COLUMN_TEMPLATE => 'modules/CDev/XPaymentsConnector/order/transactions/links.tpl',
                static::COLUMN_ORDERBY  => 100,
            ),
            'actions' => array(
                static::COLUMN_TEMPLATE => 'modules/CDev/XPaymentsConnector/order/transactions/actions.tpl',
                static::COLUMN_NO_WRAP  => true,
                static::COLUMN_ORDERBY  => 300,
                static::COLUMN_MAIN     => true,
            ),
            'fraud_warning' => array(
                static::COLUMN_TEMPLATE => 'modules/CDev/XPaymentsConnector/order/transactions/fraud.tpl',
                static::COLUMN_NO_WRAP  => true,
