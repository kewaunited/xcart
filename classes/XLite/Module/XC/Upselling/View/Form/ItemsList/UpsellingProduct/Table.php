...
namespace XLite\Module\XC\Upselling\View\Form\ItemsList\UpsellingProduct;

/**
 * U products list table form
 */
class Table extends \XLite\View\Form\ItemsList\AItemsList
{
    ...
    protected function getDefaultParams()
    {
        ...
        $list[\XLite\Module\XC\Upselling\View\ItemsList\Model\UpsellingProduct::PARAM_PARENT_PRODUCT_ID]
            = \XLite\Core\Request::getInstance()->product_id ? : \XLite\Core\Request::getInstance()->id;
