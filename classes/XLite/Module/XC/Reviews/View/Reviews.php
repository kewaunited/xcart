 ...
 */
class Reviews extends \XLite\View\AView
{
    /**
    ...
    {
        return 'modules/XC/Reviews/reviews/body.tpl';
    }
    ...
    {
        return 0 < \XLite\Core\Database::getRepo('XLite\Module\XC\Reviews\Model\Review')->count();
    }
}
