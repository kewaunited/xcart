 ...
 */
class CssJs extends \XLite\View\Tabs\CssJs implements \XLite\Base\IDecorator
{
    /**
    ...
    public function __construct(array $params = array())
    {
        if (!isset($this->tabs['custom_css'])) {
            $this->tabs = array_merge(
                array(
                    'theme_tweaker_templates' => array(
                        'weight'    => 200,
                        'title'     => 'Webmaster mode',
                        'template'  => 'modules/XC/ThemeTweaker/theme_tweaker_templates/body.tpl',
                    ),
                    'custom_css' => array(
                        'weight'    => 300,
                        'title'     => 'Custom CSS',
