...
class Branch extends \XLite\View\AView
{
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += array(
            static::PARAM_TYPE => new \XLite\Model\WidgetParam\String(
                'Page type', null, false
            ),
            static::PARAM_ID => new \XLite\Model\WidgetParam\Int(
                'Page ID', 0, false
            ),
            static::PARAM_LEVEL => new \XLite\Model\WidgetParam\Int(
                'Level', 0, false
            ),
        );
    }
    ...
    {
        return 'modules/XC/Sitemap/branch.tpl';
    }
