...
abstract class ACustomer extends \XLite\View\ItemsList\Product\AProduct
{
    ...
    public function getProductCellClass(\XLite\Model\Product $product)
    {
        return 'product productid-'
            ...
            . ($this->isGotoProduct($product) ? ' need-choose-options' : '');
    }

    /**
     * Check - go to product page insteda add to cart
     * 
     * @param \XLite\Model\Product $product Product
     *  
     * @return boolean
     */
    protected function isGotoProduct(\XLite\Model\Product $product)
    {
        return static::$forceChooseOptions && $product->hasEditableAttributes();
    }
