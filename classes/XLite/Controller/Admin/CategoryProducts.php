...
class CategoryProducts extends \XLite\Controller\Admin\ProductList
{
    ...
    {
        return static::t('Manage category (X)', array('category_name' => $this->getCategoryName()));
    }
    ...
    {
        $list = new \XLite\View\ItemsList\Model\Product\Admin\CategoryProducts();
        $list->processQuick();
    }
    ...
    {
        $cellName = \XLite\View\ItemsList\Model\Product\Admin\CategoryProducts::getSessionCellName();
    ...
    protected function getSearchParams()
    {
        ...
        foreach (
            \XLite\View\ItemsList\Model\Product\Admin\CategoryProducts::getSearchParams() as $requestParam
        ) {
