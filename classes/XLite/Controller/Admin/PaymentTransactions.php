...
class PaymentTransactions extends \XLite\Controller\Admin\AAdmin
{
    ...
    {
        $cellName = \XLite\View\ItemsList\Model\Payment\Transaction::getSessionCellName();
    ...
    protected function getSearchParams()
    {
        ...
        foreach (\XLite\View\ItemsList\Model\Payment\Transaction::getSearchParams() as $requestParam) {
