...
/**
 * Attribute options controller
 */
class AttributeOptions extends \XLite\Controller\Admin\AAdmin
{
    ...
    protected function getSearchParams()
    {
        ...
        foreach (
            \XLite\View\ItemsList\Model\AttributeOption::getSearchParams() as $requestParam
        ) {
