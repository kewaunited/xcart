...
class Memberships extends \XLite\Controller\Admin\AAdmin
{
    ...
    {
        $list = new \XLite\View\ItemsList\Model\Membership;
        $list->processQuick();
    }
    ...
    {
        $cellName = \XLite\View\ItemsList\Model\Membership::getSessionCellName();
    ...
    protected function getSearchParams()
    {
        ...
        foreach (
            \XLite\View\ItemsList\Model\Membership::getSearchParams() as $requestParam
        ) {
