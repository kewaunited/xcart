...
abstract class ProductAbstract extends \XLite\Model\Base\Catalog implements \XLite\Model\Base\IOrderItem
{
    ...
    /**
     * Flag: false - product is shippable, false - product is not shippable
     *
     * @var boolean
     *
     * @Column (type="boolean")
    ...
    {
        return $this->getInventory()->getPublicAmount();
    }
    ...
    {
        $this->sku = substr($sku, 0, \XLite\Core\Database::getRepo('XLite\Model\Product')->getFieldInfo('sku', 'length'));
    }
