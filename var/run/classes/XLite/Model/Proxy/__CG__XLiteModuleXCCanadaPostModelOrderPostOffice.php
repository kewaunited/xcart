...
class PostOffice extends \XLite\Module\XC\CanadaPost\Model\Order\PostOffice implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'order', 'officeId', 'name', 'location', 'distance', 'bilingualDesignation', 'city', 'latitude', 'longitude', 'postalCode', 'province', 'officeAddress', 'workingHours');
        }
