...
class Cart extends \XLite\Model\Cart implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'capostParcels', 'capostReturns', 'capostOffice', 'auctionIncPackage', 'fraud_status_xpc', 'fraud_type_xpc', 'usedCoupons', 'order_id', 'profile', 'orig_profile', 'shipping_id', 'shipping_method_name', 'payment_method_name', 'tracking', 'date', 'lastRenewDate', 'paymentStatus', 'shippingStatus', 'notes', 'adminNotes', 'details', 'trackingNumbers', 'events', 'items', 'surcharges', 'payment_transactions', 'currency', 'orderNumber', 'addItemError', 'oldPaymentStatus', 'isRemoving', 'oldShippingStatus', 'modifiers', 'shippingProcessor', 'isNotificationSent', 'ignoreCustomerNotifications', 'isNotificationsAllowedFlag', 'statusIsSet', 'paymentTransactionSums', 'total', 'subtotal');
        }
    ...
    public function isItemVariantIdEqual(\XLite\Model\OrderItem $item, $variantId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isItemVariantIdEqual', array($item, $variantId));

        return parent::isItemVariantIdEqual($item, $variantId);
    }
    ...
    public function getItemsByVariantId($variantId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getItemsByVariantId', array($variantId));

        return parent::getItemsByVariantId($variantId);
    }
    ...
    public function getItemsIncludeSurchargesTotals()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getItemsIncludeSurchargesTotals', array());
