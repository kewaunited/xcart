...
namespace XLite\Model\Proxy\__CG__\XLite\Module\XC\ProductVariants\Model\Image\ProductVariant;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class Image extends \XLite\Module\XC\ProductVariants\Model\Image\ProductVariant\Image implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'product_variant', 'alt', 'width', 'height', 'hash', 'needProcess', 'id', 'path', 'fileName', 'mime', 'storageType', 'size', 'date', 'loadError');
        }
    ...
    public function setProductVariant(\XLite\Module\XC\ProductVariants\Model\ProductVariant $productVariant = NULL)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setProductVariant', array($productVariant));

        return parent::setProductVariant($productVariant);
    }
    ...
    public function getProductVariant()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getProductVariant', array());
