...
class AttributeValueCheckbox extends \XLite\Model\AttributeValue\AttributeValueCheckbox implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'variants', 'value', 'translations', 'priceModifier', 'priceModifierType', 'weightModifier', 'weightModifierType', 'defaultValue', 'id', 'product', 'attribute', 'editLanguage');
        }
