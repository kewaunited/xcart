...
class NewsMessage extends \XLite\Module\XC\News\Model\NewsMessage implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'enabled', 'date', 'cleanURLs', 'metaDescType', 'translations', 'editLanguage');
        }
    ...
    public function setBody($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setBody', array($value));
