...
class Coupon extends \XLite\Module\CDev\Coupons\Model\Coupon implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'code', 'enabled', 'value', 'type', 'comment', 'uses', 'dateRangeBegin', 'dateRangeEnd', 'totalRangeBegin', 'totalRangeEnd', 'usesLimit', 'singleUse', 'productClasses', 'memberships', 'usedCoupons', 'categories');
        }
    ...
    public function isValidItem($item)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'isValidItem', array($item));

        return parent::isValidItem($item);
    }
    ...
    public function checkMembershipId(\XLite\Model\Membership $item, $membershipId)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'checkMembershipId', array($item, $membershipId));
