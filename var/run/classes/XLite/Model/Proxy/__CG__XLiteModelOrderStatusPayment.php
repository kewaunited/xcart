...
class Payment extends \XLite\Model\Order\Status\Payment implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'translations', 'id', 'code', 'position', 'editLanguage');
        }
    ...
    public function setCustomerName($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setCustomerName', array($value));
