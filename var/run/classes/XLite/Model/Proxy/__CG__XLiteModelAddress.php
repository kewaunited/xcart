...
class Address extends \XLite\Model\Address implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'addressFields', 'is_billing', 'is_shipping', 'isWork', 'profile', 'address_id', 'address_type', 'state', 'country');
        }
    ...
    public function duplicateStateName()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'duplicateStateName', array());

        return parent::duplicateStateName();
    }
