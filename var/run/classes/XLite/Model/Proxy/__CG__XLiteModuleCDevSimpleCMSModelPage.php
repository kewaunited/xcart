...
class Page extends \XLite\Module\CDev\SimpleCMS\Model\Page implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'ogMeta', 'showSocialButtons', 'id', 'enabled', 'image', 'cleanURLs', 'metaDescType', 'translations', 'editLanguage');
        }
    ...
    public function setTeaser($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setTeaser', array($value));
    ...
    public function setMetaKeywords($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setMetaKeywords', array($value));
