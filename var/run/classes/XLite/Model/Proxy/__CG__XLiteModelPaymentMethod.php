...
class Method extends \XLite\Model\Payment\Method implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'method_id', 'service_name', 'class', 'moduleName', 'orderby', 'enabled', 'moduleEnabled', 'added', 'type', 'settings', 'fromMarketplace', 'iconURL', 'countries', 'exCountries', 'translations', 'editLanguage');
        }
    ...
    public function setAdminDescription($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAdminDescription', array($value));
    ...
    public function setAltAdminDescription($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setAltAdminDescription', array($value));

        return parent::setAltAdminDescription($value);
    }
    ...
    public function setInstruction($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setInstruction', array($value));
