...
class LanguageLabel extends \XLite\Model\LanguageLabel implements \Doctrine\ORM\Proxy\Proxy
{
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'label_id', 'name', 'translations', 'editLanguage');
        }
    ...
    public function setLabel($value)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setLabel', array($value));

        return parent::setLabel($value);
    }
