...
/**
 * @MappedSuperClass (repositoryClass="\XLite\Model\Repo\Attribute")
 */
abstract class AttributeAbstract extends \XLite\Model\Base\I18n
{
     ...
     *
     * @OneToMany (targetEntity="XLite\Model\AttributeTranslation", mappedBy="owner", cascade={"all"})
     */
    ...
    {
        return $this->getSoftTranslation()->getUnit();
    }
    ...
    public function setUnit($value)
    {
        ...
        return $translation->setUnit($value);
    }
