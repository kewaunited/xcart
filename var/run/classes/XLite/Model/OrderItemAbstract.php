...
/**
 * @MappedSuperClass (repositoryClass="\XLite\Model\Repo\OrderItem")
 */
abstract class OrderItemAbstract extends \XLite\Model\Base\SurchargeOwner
{
    ...
    public function hasWrongAmount()
    {
        ...
        return $inventory->getEnabled()
            && ($inventory->getPublicAmount() < $this->getAmount());
    }
    ...
    public function canChangeAmount()
    {
        ...
        return !$product
            ...
            || 0 < $product->getInventory()->getPublicAmount();
    ...
    public function setAttributeValues(array $attributeValues)
    {
        ...
        foreach ($attributeValues as $av) {
            ...
            $newValue->setAttributeValueId($av->getId());
