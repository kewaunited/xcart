...
class Payment extends \XLite\Model\Order\Status\AStatus
{
     ...
     *
     * @OneToMany (targetEntity="XLite\Model\Order\Status\PaymentTranslation", mappedBy="owner", cascade={"all"})
     */
    ...
    {
        return $this->getSoftTranslation()->getCustomerName();
    }
    ...
    public function setCustomerName($value)
    {
        ...
        return $translation->setCustomerName($value);
    }
