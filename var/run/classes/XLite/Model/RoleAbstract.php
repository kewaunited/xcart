...
/**
 * @MappedSuperClass (repositoryClass="\XLite\Model\Repo\Role")
 */
abstract class RoleAbstract extends \XLite\Model\Base\I18n
{
    /**
     * ID
     *
     ...
     *
     * @OneToMany (targetEntity="XLite\Model\RoleTranslation", mappedBy="owner", cascade={"all"})
     */
