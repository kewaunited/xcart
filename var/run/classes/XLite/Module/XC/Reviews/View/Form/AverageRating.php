...
class AverageRating extends \XLite\View\Form\AForm
{
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += array(
            self::PARAM_PRODUCT_ID      => new \XLite\Model\WidgetParam\Int('Product Id', 0),
            self::PARAM_RETURN_TARGET   => new \XLite\Model\WidgetParam\String('Return target', '', false),
            self::PARAM_TARGET_WIDGET   => new \XLite\Model\WidgetParam\String('Target widget', '', false),
        );
    }
