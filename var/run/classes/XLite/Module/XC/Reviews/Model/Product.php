 ...
 * @MappedSuperClass
 */
abstract class Product extends \XLite\Module\XC\ProductVariants\Model\Product implements \XLite\Base\IDecorator
{
    /**
     * Product reviews
     *
    ...
    public function getAverageRating()
    {
        if (!isset($this->averageRating)) {
            ...
            $this->averageRating = (0 < $votesCount)
    ...
    public function getReviewAddedByUser(\XLite\Model\Profile $profile = null, $findByIp = true)
    {
        if (!isset($this->reviewAddedByUser)) {
            $this->reviewAddedByUser = $this->getReviewAddedByUserFromDb($profile, $findByIp);
        }
     ...
     * @return \XLite\Module\XC\Reviews\Model\Review
     */
    protected function getReviewAddedByUserFromDb(\XLite\Model\Profile $profile = null, $findByIp = true)
    {
        $review = null;
