 ...
 * Decorate SaleBlock
 *
 * @LC_Dependencies("CDev\Sale")
 */
abstract class SaleBlock extends \XLite\Module\CDev\Sale\View\SaleBlockAbstract implements \XLite\Base\IDecorator
{
    /**
    ...
    protected function getSearchConditions(\XLite\Core\CommonCell $cnd)
    {
        ...
        if ($this->getCategoryId() && 'product' == $this->getTarget()) {
            ...
            $cnd->{\XLite\Model\Repo\Product::P_CATEGORY_ID} = $categoryId ?: $this->getCategoryId();
        }
