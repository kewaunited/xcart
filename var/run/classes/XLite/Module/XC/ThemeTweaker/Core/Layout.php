 ...
 * Layout manager
 */
abstract class Layout extends \XLite\Module\XC\Sitemap\Core\Layout implements \XLite\Base\IDecorator
{
    /**
     ...
     * @return array
     */
    public function getSkinPaths($interface = null, $isModuleResource = false, $reset = false)
    {
        return 'custom' == $interface
            ...
            : parent::getSkinPaths($interface, $isModuleResource, $reset);
    }
}
