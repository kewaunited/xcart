 ...
 *
 * @ListChild (list="invoice.bottom", weight="15", zone="customer")
 */
class DeliveryToPost extends \XLite\View\AView
{
    ...
    {
        return 'modules/XC/CanadaPost/order/invoice/parts/bottom.d2po.tpl';
    }
