 ...
 *
 */
abstract class OrderItem extends \XLite\Module\XC\FreeShipping\Model\OrderItemCoupon implements \XLite\Base\IDecorator
{
    /**
     * Product variant
     *
    ...
    public function hasWrongAmount()
    {
        return $this->getVariant() && !$this->getVariant()->getDefaultAmount()
            ? $this->getVariant()->getAmount() < $this->getVariant()->getLockedAmount()
