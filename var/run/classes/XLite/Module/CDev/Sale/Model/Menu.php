 ...
 * @MappedSuperClass
 */
abstract class Menu extends \XLite\Module\CDev\ProductAdvisor\Model\Menu implements \XLite\Base\IDecorator
{
    ...
    protected function defineLinkControllers()
    {
        ...
        $list[static::DEFAULT_SALE_PAGE] = '\XLite\Controller\Customer\SaleProducts';
