 ...
 */
abstract class Transaction extends \XLite\Module\CDev\XPaymentsConnector\Model\Repo\Payment\BackendTransaction implements \XLite\Base\IDecorator
{
    /**
    ...
    {
        $qb->select('COUNT(DISTINCT bt.id)');
