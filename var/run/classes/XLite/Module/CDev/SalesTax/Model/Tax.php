 ...
 * Tax
 *
 * @Entity (repositoryClass="\XLite\Module\CDev\SalesTax\Model\Repo\Tax")
...
class Tax extends \XLite\Model\Base\I18n
{
     ...
     * @var \Doctrine\Common\Collections\ArrayCollection
     *
     * @OneToMany (targetEntity="XLite\Module\CDev\SalesTax\Model\TaxTranslation", mappedBy="owner", cascade={"all"})
     */
