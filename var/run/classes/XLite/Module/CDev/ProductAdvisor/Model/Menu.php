 ...
 * @MappedSuperClass
 */
abstract class Menu extends \XLite\Module\CDev\ContactUs\Model\Menu implements \XLite\Base\IDecorator
{
    ...
    protected function defineLinkControllers()
    {
        ...
        $list[static::DEFAULT_COMING_SOON] = '\XLite\Controller\Customer\ComingSoon';
        $list[static::DEFAULT_NEW_ARRIVALS] = '\XLite\Controller\Customer\NewArrivals';
