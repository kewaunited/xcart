...
class ExpressCheckout extends \XLite\Module\CDev\Paypal\View\Button\AExpressCheckout
{
    ...
    {
        return 'modules/CDev/Paypal/button/cart/default/express_checkout.tpl';
    }
    ...
    protected function getTemplate()
    {
        return $this->isInContextAvailable()
            ? 'modules/CDev/Paypal/button/cart/in_context/express_checkout.tpl'
            : 'modules/CDev/Paypal/button/cart/default/express_checkout.tpl';
    }
