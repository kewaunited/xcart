...
class Install extends \XLite\View\ItemsList\Module\AModule
{
    ...
    protected function defineWidgetParams()
    {
        ...
        $this->widgetParams += array(
            ...
            static::PARAM_VENDOR => new \XLite\Model\WidgetParam\String(
                'Vendor', ''
            ),
            static::PARAM_PRICE => new \XLite\Model\WidgetParam\Set(
    ...
    {
        return in_array($this->getParam(static::PARAM_VENDOR), $this->getVendorOptions())
