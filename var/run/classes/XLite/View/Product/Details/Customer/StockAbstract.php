 ...
 * Stock
 */
abstract class StockAbstract extends \XLite\View\Product\Details\Customer\Widget
{
    /**
    ...
    {
        return 'product/details/stock/body.tpl';
    }
    ...
    {
        return $this->getProduct()->getInventory()->getAvailableAmount();
    }
